  ...
  <section id="banner" class="banner">
    ...
    <main role="main">
	   ...
	   <th>Action</th>
              ...
              <tr>
              <td>${c.bookingid}</td>
              <%-- <td><fmt:formatDate pattern="yyyy-MM-dd" value="${c.Booking_show}"/></td> --%>  
            
              <td>${c.firstname}</td>
              <td>${c.lastname}</td>
              <td>${c.pgname}</td>
              <td><a href="<j:url value='/declineBooking/${c.bookingid}'/>" style="color:red"><button class="but3">Decline</button></a></td>
