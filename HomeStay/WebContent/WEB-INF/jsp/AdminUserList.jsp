...
<table>
		...
		<j:forEach var="c" items="${adminUserList}">
		...
		<td>${c.email}</td>
		<td>${c.user_id}</td>
		<%-- <td><a href="<j:url value='/deleteUser/${c.uId}'/>"  style="color:red"><button id="but1">Delete</button></a></td> --%>
		 <td><a href="<j:url value='/deleteUser/${c.u_id}'/>" style="color:red"><button id="but3">Delete</button></a></td>
</tr>
</j:forEach>
</table>
</j:if>
