...
<j:if test="${!empty DeletedUsers}">
	<table style="width:100%" >
		...
		<j:forEach var="c" items="${DeletedUsers}">
		...
		<td>${ c.email}</td>
		<td>${ c.user_id}</td> 
		 <td><a href="<j:url value='/AcceptUser/${c.u_id}'/>" style="color:blue"><button id="but1">Accept</button></a></td> 
</tr>
</j:forEach>
</table>
</j:if>
