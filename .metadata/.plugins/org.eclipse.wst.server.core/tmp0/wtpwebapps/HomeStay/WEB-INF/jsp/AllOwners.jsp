...
<j:if test="${!empty listOwner}">
	<table style="width:100%" >
		...
		<j:forEach var="c" items="${listOwner}">
		...
		<td>${ c.email}</td>
		<td>${ c.user_id}</td>
		 <%-- <td><a href="<j:url value='/deleteHospital/${c.user_id}'/>" style="color:red"><button id="but1">Delete</button></a></td> --%> 
