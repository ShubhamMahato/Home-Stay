...
<j:if test="${!empty DeletedOwners}">
	<table style="width:100%" >
		...
		<j:forEach var="c" items="${DeletedOwners}">
		...
		<td>${ c.email}</td>
		<td>${ c.user_id}</td>
		 <td><a href="<j:url value='/AcceptOwner/${c.u_id}'/>" style="color:blue"><button id="but3">Accept</button></a></td> 
</tr>
</j:forEach>
</table>
</j:if>
