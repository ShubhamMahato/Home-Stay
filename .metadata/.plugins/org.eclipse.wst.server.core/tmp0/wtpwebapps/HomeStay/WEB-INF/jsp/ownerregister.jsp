...
<c:url var="action" value="add1"></c:url>
<form:form action="${action}" modelAttribute="owner" method="POST">
      ...
      <form:errors path="first_name" cssClass="error"></form:errors>
       ...
       <form:input class="un " align="center" placeholder="last Name" path="last_name"></form:input>
        ...
        <br>
         ...
         <form:select class="un" items="${genderlist}" path="gender"/>
          ...
          <form:errors path="user_id" cssClass="error"></form:errors>
              <form:password class="pass"  align="center" placeholder="Password" path="password"></form:password>
